...
> **Provenance:** [wshobson/agents](https://github.com/wshobson/agents), path
> `plugins/python-development/skills/python-design-patterns/`. Fetched 2026-08-12.
> Registry: 18.3K installs · repo 38.7K stars · last push 2026-08-05.
> **Not installed** — this is a local read-only copy for comparison. Install with:
> `npx skills add wshobson/agents@python-design-patterns`
>
> **Complete.** The skill ships exactly two files, both reproduced below verbatim: `SKILL.md` (4.7 KB,
> navigation tier) and `references/details.md` (11 KB, detail tier). No scripts, no other assets.

---

## Part 1 of 2 — `SKILL.md`
...
## Part 2 of 2 — `references/details.md`
